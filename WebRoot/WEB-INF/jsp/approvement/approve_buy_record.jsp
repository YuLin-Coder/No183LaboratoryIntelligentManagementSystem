...
<html>
  <head>
    ...
    <link rel="stylesheet" href="<%= path %>/static/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">
    <script type="text/javascript" src="<%= path %>/static/js/lib/jquery-3.3.1.min.js"></script>
    <script src="<%= path %>/static/js/bootstrap.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
      ...
      <div class="record-content">
        ...
        <div class="record-right">
          <div class="record-right-title">
            ...
            <form action="<%= path %>/approvement/m/buy-record" method="get" id="searchForm">
...
<!--                       <a data-toggle="modal" data-target="#myModal"> -->
                      <a href="<%= path %>/approvement/m/buy-record/${record.id }">
            ...
            <nav aria-label="Page navigation" class="pagination-nav text-center">
              <ul class="pagination">
                <c:if test="${pagination.currentPage > 1 }">
                  <li>
                    <a href="<%= path %>/approvement/m/buy-record?searchKeyWord=${pagination.searchKeyWord }&page=1&orderBy=${orderBy }" aria-label="Previous">
                      <span aria-hidden="true">&laquo;</span>
                    </a>
                  </li>
                  <li>
                    <a href="<%= path %>/approvement/m/buy-record?searchKeyWord=${pagination.searchKeyWord }&page=${pagination.currentPage - 1 }&orderBy=${orderBy }" aria-label="Previous">
                ...
                <c:forEach items="${pagination.pagesList }" varStatus="i" var="pageIndex">
                  <c:choose>
                    ...
                    <c:otherwise>
                      <li><a href="<%= path %>/approvement/m/buy-record?searchKeyWord=${pagination.searchKeyWord }&page=${pageIndex }&orderBy=${orderBy }">${pageIndex }</a></li>
                    </c:otherwise>
                  </c:choose>
                </c:forEach>
                ...
                <c:if test="${pagination.currentPage < pagination.totalPage}">
                  ...
                  <li>
                    <a href="<%= path %>/approvement/m/buy-record?searchKeyWord=${pagination.searchKeyWord }&page=${pagination.totalPage }&orderBy=${orderBy }" aria-label="Previous">
